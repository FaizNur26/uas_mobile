    ...
    return MaterialApp(
      darkTheme: ThemeData(
        ...
        colorScheme: ColorScheme(
          ...
          background: Color.fromRGBO(0, 0, 1, 1),
                ...
                child: GridView.extent(
                  ...
                  children: List<Widget>.generate(
                    ...
                    (index) {
                      ...
                      final endInterval =
                          math.min<double>(1, (1 / count) * (index + 5));
...
class DotaHero {
  ...
  static List<DotaHero> get favoriteHeroes => [
        DotaHero(
          ...
          color: Colors.blue,
          bio:
              "Terdapat seorang master yang menguasai seni Yin Yang  dengan menggunakan bantuan roh yang sangat kuat dari Yin dan Yang. Seorang master seni Yin Yang tersebut dikenal dengan sebutan Onmyouji Master. Onmyouji Master yang terkuat pada saat ini adalah Ancesor Master yang merupakan salah satu keluarga Onmyuji dengan potensi paling besar. Sebutan Ancesor Master saat ini dimiliki oleh seorang gadis bernama Kagura yang telah memiliki payung Seimei."
              "Payung Seimei merupakan pusaka seni Yin yang selalu diwariskan kepada mereka para Ancesor Master terkuat dari generasi ke generasi. Dikatakan bahwa payung Seimei itu telah diperkuat oleh sang Greatt Seimei dengan menggunakan kekuatan dari seratus roh orang kuat. Payung ini sudah selayaknya dimiliki Kagura sebab kekuatannya hanya bisa dikontrol oleh Ancesor Master terkuat. Payung ini hanya akan menjadi payung biasa apabila digunakan oleh orang yang tidak sah (bukan sang pemilik sah)."
              "Kagura memiliki teman sejak kecil yang merupakan seorang Ninja Shadow terkuat saat itu. Ia adalah Hayabusa seorang ninja yang telah dipersiapkan menjalani latihan khusus agar dapat menjadi Ninja terkuat di kelompok Ninja Shadow. Hayabusa akan menjalani misi penting untuk membunuh mantan Ninja Shadow pengkhianat yang telah membunuh ninja lain."
              "Kagura selalu menemani Hayabusa untuk melihat rembulan di malam hari agar dapat menghibur temannya itu setelah seharian menjalani latihan khusus. Namun hubungan Kagura dan Hayabusa tidak disukai oleh Hanabi yang merupakan seorang ninja perempuan yang hebat dari kelompok Ninja Scarlet. Hanabi menyukai Hayabusa dan merasa cemburu ketika ia melihat Haybusa dan Kagura menghabiskan waktu bersama. Namun meskipun begitu, Hanabi tidak ingin merusak hubungan dari mereka."
            ,
          ...
          roles: ['Mage', 'Poke', 'Reap'],
          levels: [
            HeroLevel(
              name: 'Skill Pasif – Yin Yang Gathering',
              description:
                  'Ketika Kagura mengambil payung, ia mendapatkan shield dan menyebabkan efek stun kepada lawan yang berada di dekatnya.',
              imageUrl:
            ...
            HeroLevel(
              name: 'Skill 1 – Seimei Umbrella Open (Biru)',
              description:
                  'Kagura melemparkan payung, memberikan 290 (+105%) magic damage kepada lawan yang berada di sepanjang jalan dan menyebabkan efek slow.',
              imageUrl:
            ...
            HeroLevel(
              name: 'Skill 2 – Rasho Umbrella Flee (Biru)',
              description:
                  " Kagura meninggalkan payungnya di belakang, menghapus semua debuff dan bergerak ke arah yang ditentukan.",
              imageUrl:
            ...
            HeroLevel(
              name: 'Skill Ultimate – Yin Yang Overturn (Biru)',
              description:
                  "Dengan payung, Kagura memberikan 330 magic damage menyebabkan efek knockback kepada lawan dan menyebabkan efek slow sebesar 65%.",
              imageUrl:
        ...
        DotaHero(
          name: 'Miya',
          imagePath:
              'https://raw.githubusercontent.com//FaizNur26/Uas_AdvanceMobileProgramming/kagura.jpg',
          users: '33k',
          color: Colors.orange,
          bio:
        ...
        DotaHero(
          ...
          bio:
              "Darkterror the Faceless Void is a visitor from Claszureme, a realm outside of time."
